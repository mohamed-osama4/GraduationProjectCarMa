...
const Reports = () => {
  ...
  const dailyOrdersData = [
    ...
    { name: 'الثلاثاء', value: 60 },
    { name: 'الأربعاء', value: 55 },
    { name: 'الخميس', value: 48 },
    { name: 'الجمعة', value: 35 },
  ];

  const techPerformanceData = [
    { name: 'محمد أحمد', value: 230 },
    { name: 'يوسف حسن', value: 280 },
    { name: 'أحمد علي', value: 190 },
    { name: 'خالد محمود', value: 310 },
    { name: 'حسام الدين', value: 140 },
  ];

  const monthlyRevenueData = [
    { name: 'يناير', value: 40000 },
    { name: 'فبراير', value: 38000 },
    { name: 'مارس', value: 45000 },
    { name: 'أبريل', value: 50000 },
    { name: 'مايو', value: 48000 },
    { name: 'يونيو', value: 55000 },
  ];

  const servicesData = [
    { name: 'تغيير الزيت', value: 40, color: '#D9B07C' },
    { name: 'تغيير البطارية', value: 25, color: '#3b82f6' },
    { name: 'خدمة الإطارات', value: 15, color: '#10b981' },
    { name: 'غسيل السيارة', value: 20, color: '#8b5cf6' },
  ];

  const topTechnicians = [
    { id: 1, name: 'محمد أحمد', rating: 4.9, orders: 234 },
    { id: 2, name: 'يوسف حسن', rating: 4.9, orders: 276 },
    { id: 3, name: 'أحمد علي', rating: 4.8, orders: 198 },
    { id: 4, name: 'خالد محمود', rating: 4.7, orders: 312 },
    { id: 5, name: 'حسام الدين', rating: 4.6, orders: 145 },
  ];

  const topServices = [
    { id: 1, name: 'تغيير الزيت', orders: 450, color: 'bg-[#D9B07C]', percent: 90 },
    { id: 2, name: 'تغيير البطارية', orders: 320, color: 'bg-blue-500', percent: 70 },
    { id: 3, name: 'خدمة الإطارات', orders: 280, color: 'bg-slate-400', percent: 60 },
    { id: 4, name: 'غسيل السيارة', orders: 410, color: 'bg-cyan-500', percent: 85 },
    { id: 5, name: 'خدمات الطوارئ', orders: 180, color: 'bg-red-500', percent: 40 },
    { id: 6, name: 'خدمة الونش', orders: 120, color: 'bg-purple-500', percent: 25 },
  ];
    ...
    <div className="font-tajawal min-h-screen pb-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <button className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-[#1a4b8c] hover:bg-[#153b70] text-white px-6 py-2.5 rounded-xl text-sm font-bold transition-all shadow-xl shadow-blue-900/20">
            <Download size={18} />
            تصدير التقرير
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-[#121212] p-6 rounded-[2rem] border border-white/5 shadow-xl">
          ...
          <div className="h-[300px] w-full" dir="ltr">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={dailyOrdersData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.05)" vertical={false} />
                <XAxis dataKey="name" stroke="#64748b" tick={{ fill: '#64748b', fontSize: 12, fontFamily: 'Tajawal' }} axisLine={false} tickLine={false} />
                <YAxis stroke="#64748b" tick={{ fill: '#64748b', fontSize: 12 }} axisLine={false} tickLine={false} />
