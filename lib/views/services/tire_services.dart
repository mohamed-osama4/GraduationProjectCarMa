...
class TireServices extends StatefulWidget {
  const TireServices({super.key});

  @override
  State<TireServices> createState() => _TireServicesState();
}

class _TireServicesState extends State<TireServices> {
  int _selectedImageIndex = 0;
  int _selectedServiceIndex = 0;
  final TextEditingController _notesController = TextEditingController();

  final List<String> _images = [
    'assets/images/tiresa.jpeg',
    'assets/images/tiresb.jpeg',
    'assets/images/tiresc.jpeg',
    'assets/images/tiresd.jpeg',
    'assets/images/tirese.jpeg',
    'assets/images/tiresf.jpeg',
  ];
  ...
  Widget build(BuildContext context) {
    ...
    // Each option multiplies the API base price (ID 3 = 250 EGP)
    const optMult = [0.4, 1.0, 0.6];
